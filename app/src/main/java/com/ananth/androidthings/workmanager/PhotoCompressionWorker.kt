package com.ananth.androidthings.workmanager
...
class PhotoCompressionWorker(
    private val appContent: Context,
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            ...
            val bytes = appContent.contentResolver.openInputStream(uri)?.use {
                it.readBytes()
            ...
            val file = File(appContent.cacheDir, "${params.id}.jpg")
